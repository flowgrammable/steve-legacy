...
constexpr Token_kind return_tok              = make_token(117);
constexpr Token_kind switch_tok              = make_token(118);
constexpr Token_kind then_tok                = make_token(119);
constexpr Token_kind typename_tok            = make_token(120);
constexpr Token_kind unit_tok                = make_token(121);
constexpr Token_kind using_tok               = make_token(122);
constexpr Token_kind variant_tok             = make_token(123);
constexpr Token_kind where_tok               = make_token(124);
constexpr Token_kind while_tok               = make_token(125);
