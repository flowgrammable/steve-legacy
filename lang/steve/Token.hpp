...
constexpr Token_kind bitfield_tok            = make_token(104);
constexpr Token_kind bool_tok                = make_token(105);
constexpr Token_kind char_tok                = make_token(106);
constexpr Token_kind def_tok                 = make_token(107);
constexpr Token_kind else_tok                = make_token(108);
constexpr Token_kind enum_tok                = make_token(109);
constexpr Token_kind export_tok              = make_token(110);
constexpr Token_kind if_tok                  = make_token(111);
constexpr Token_kind import_tok              = make_token(112);
constexpr Token_kind int_tok                 = make_token(113);
constexpr Token_kind nat_tok                 = make_token(114);
constexpr Token_kind not_tok                 = make_token(115);
constexpr Token_kind or_tok                  = make_token(116);
