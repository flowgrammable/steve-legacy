...
constexpr Token_kind break_tok               = make_token(105);
constexpr Token_kind case_tok                = make_token(106);
constexpr Token_kind char_tok                = make_token(107);
constexpr Token_kind continue_tok            = make_token(108);
constexpr Token_kind def_tok                 = make_token(109);
constexpr Token_kind else_tok                = make_token(110);
constexpr Token_kind enum_tok                = make_token(111);
constexpr Token_kind export_tok              = make_token(112);
constexpr Token_kind if_tok                  = make_token(113);
constexpr Token_kind import_tok              = make_token(114);
constexpr Token_kind int_tok                 = make_token(115);
constexpr Token_kind nat_tok                 = make_token(116);
constexpr Token_kind not_tok                 = make_token(117);
constexpr Token_kind or_tok                  = make_token(118);
constexpr Token_kind record_tok              = make_token(119);
constexpr Token_kind return_tok              = make_token(120);
constexpr Token_kind switch_tok              = make_token(121);
constexpr Token_kind then_tok                = make_token(122);
constexpr Token_kind typename_tok            = make_token(123);
constexpr Token_kind unit_tok                = make_token(124);
constexpr Token_kind using_tok               = make_token(125);
constexpr Token_kind variant_tok             = make_token(126);
constexpr Token_kind where_tok               = make_token(127);
constexpr Token_kind while_tok               = make_token(128);
